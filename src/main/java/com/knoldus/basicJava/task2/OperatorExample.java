...
package com.knoldus.basicJava.task2;

public class OperatorExample {
    public static void main(String[] args) {
        double firstNumber = 3.14, secondNumber = 6.28, sumOfTwoNumbers;
        sumOfTwoNumbers = firstNumber + secondNumber;
        System.out.println(firstNumber + " + " + secondNumber + " = " + sumOfTwoNumbers);
    }
}
